  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
		...
		if(data.code?.length !== 6) return setError("Invalid validation code.")
			...
			if (!res || res.error) {setError("Código inválido ou expirado.")} 
			else {
		...
		<section className="contact" id="login">
			...
			<div className="contact-form">
				<form onSubmit={handleSubmit} className="form">
					...
					<div className="form-group">
						<label htmlFor="code">Verification code ( check your e-mail) 
					...
					<button type="submit" className="submit-btn mb-12">Start</button>
